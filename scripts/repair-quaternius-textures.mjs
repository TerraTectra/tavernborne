...
const pbrFallbacks = new Map([
  ...
  ['t_woodtrim_basecolor.png', 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR4nGOoizD5DwAEbAIKxV26LQAAAABJRU5ErkJggg=='],
  ['t_woodtrim_normal.png', 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR4nGNoaPj/HwAGggL/s75RMwAAAABJRU5ErkJggg=='],
  ['t_woodtrim_roughness.png', 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR4nGPYtGnTfwAHRgMWwm+yngAAAABJRU5ErkJggg=='],
